# pricing-episode-code-edition-reconciliation Specification

## Purpose
Deterministically reconcile provider pricing rows with local cards using edition identity derived from `episode.code`, with ordered fallback matching.
